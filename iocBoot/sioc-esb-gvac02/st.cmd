...
epicsEnvSet("P",         "ESB:GVAC02")
epicsEnvSet("PROTOFILE", "gVac.proto")
epicsEnvSet("LOC",       "B062-38-04")
...
drvAsynIPPortConfigure ("L0","ts-esb-11:2103",0,0,0)

#asynSetTraceMask("L0",-1,0x9)
#asynSetTraceIOMask("L0",-1,0x2)

dbLoadRecords("db/gVac02.db","IOC=${IOC},P=$(P),PROTOFILE=$(PROTOFILE),PORT=L0,LOC=$(LOC)")
